 ...
 * @author TIMEs
 */
public class FixDepAccount extends javax.swing.JFrame {

    /**
     * Creates new form ReccuringAccount
     */
    public FixDepAccount() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 145, -1, 50));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 185, -1, 50));
        ...
        getContentPane().add(number, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 200, 161, -1));
        ...
        getContentPane().add(nic, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 240, 160, 20));
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 260, -1, 60));
        ...
        jLabel7.setText("Fix Deposit Account");
    ...
    String num;
    num = JOptionPane.showInputDialog(null, "How many Years", "Year");
    double num2 = Double.parseDouble(num);
    tot = (((DEP*num2*3.8*12)/100)+DEP);
    ...
    new IntrestPerYear(ame,numb,money,cnic).setVisible(true);
    ...
    try
    {
        FileWriter Writer = new FileWriter("C:\\Users\\ABC\\Desktop\\Meezan BankProject\\Fix Deposit Accounts\\"+pame+".txt",true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FixDepAccount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FixDepAccount().setVisible(true);
            }
        });
    }
